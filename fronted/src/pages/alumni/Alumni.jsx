...
export default function Alumni() {
    ...
    return (
        <div>
            ...
            <div className="p-10 border border-black w-[95vw] h-screen grid grid-cols-1 md:grid-cols-2 gap-3">
                {alumni.map((person) => 
                    {
                        return <div className='p-2 rounded text-white bg-black w-fit h-fit'>
