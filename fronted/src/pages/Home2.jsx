  ...
  <div class="relative isolate px-6 pt-14 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
      ...
      <div class="text-center">
        <h1 class="text-5xl font-semibold tracking-tight text-balance text-white sm:text-7xl">Alumni Data</h1>
        <p class="mt-8 text-lg font-medium text-pretty text-gray-400 sm:text-xl/8"> Here we Store</p>
