...
const AdminSignup = () => {
    ...
    return (
        <div className="max-w-md mx-auto bg-white p-6 rounded shadow">
            <h2 className="text-xl font-semibold mb-4">Sign up As Admin</h2>
            ...
            <form onSubmit={submit} className="space-y-3">
                ...
                <h3 className='text-red-400'>
                    <span className='font-bold text-black'>NOTE:-</span>If not verified within 3-days account will be deleted automatically
                </h3>
            </form>
        </div>
    )
